...
def insert_proposal(demand_id, proposal_file, proposal_file_name, date_received, proposal_status, comments):
    try:
        ...
        cursor.close()
        conn.close()
        st.success("✅ Proposal successfully uploaded and saved.")
    except Exception as e:
...
st.title("📑 Proposal Registration")
...
if selected_demand:
    ...
    st.markdown("### 📜 Previous Proposals for This Demand")
...
if st.button("Submit Proposal"):
    if demand_id and date_received and proposal_status and comments and proposal_pdf:
        ...
        st.warning("🚨 Please fill all fields and upload the proposal PDF.")
